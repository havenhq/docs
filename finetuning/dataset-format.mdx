...
Your training dataset should be a `jsonl` file. Each line of the file should contain a json object representing a chat. A chat json object contains a `messages` field, which looks like this:
